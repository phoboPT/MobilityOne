...
Object.defineProperty(exports, "OrderStatus", { enumerable: true, get: function () { return common_lib_1.OrderStatus; } });
const orderSchema = new mongoose_1.default.Schema({
    ...
    status: {
        type: String,
        required: true,
        enum: Object.values(common_lib_1.OrderStatus),
        default: common_lib_1.OrderStatus.Created,
    },
    expiresAt: {
